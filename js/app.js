...
const PRODUCTS = [
  {
    ...
    descripcion: 'Suplemento dietario en cápsulas formulado con vitaminas D6, B1, B5 y calcio. Apoya el cuidado integral de las articulaciones y la movilidad diaria.\nBeneficios: articulaciones, movilidad y aporte de vitaminas.\nCantidad: 100 cápsulas.\nConcentración: 300 mg.',
    precio: 68500,
    imagen: 'assets/products/Cartilg_fondo.jpg',
    destacado: false
  },
  {
    id: 2,
    ...
    descripcion: 'Suplemento dietario en cápsulas con chancapiedra, diente de león y cola de caballo. Apoya la salud renal, la limpieza natural y el efecto diurético.\nBeneficios: salud renal, eliminación de líquidos y bienestar.\nCantidad: 100 cápsulas.\nConcentración: 300 mg.',
    precio: 68500,
    imagen: 'assets/products/Chanca Dra_fondo.jpg',
    destacado: false
  },
  {
    id: 3,
    nombre: 'Citrato de Magnesio + Citrato de Potasio — Totalmax',
    categoria: 'Energía',
    categoriasSecundarias: ['Movimiento', 'Bienestar'],
    descripcion: 'Suplemento alimenticio masticable con citrato de magnesio y citrato de potasio. Apoya la energía, la función muscular, la hidratación y el equilibrio corporal.\nBeneficios: energía diaria, músculos, electrolitos y bienestar integral.\nCantidad: 30 unidades.\nConcentración: 1000.\nContenido neto: 30 g.',
    precio: 48500,
    imagen: 'assets/products/Citrato de magnesio_fondo.jpg',
    destacado: true
  },
  {
    id: 4,
    nombre: 'Citrato de Zinc — Totalmax',
    categoria: 'Defensas',
    categoriasSecundarias: ['Energía', 'Bienestar'],
    descripcion: 'Suplemento alimenticio masticable con citrato de zinc. Apoya las defensas, la vitalidad, el metabolismo activo y el cuidado nutricional.\nBeneficios: apoyo inmune, absorción, defensas y bienestar.\nCantidad: 30 unidades.\nConcentración: 600.\nContenido neto: 18 g.',
    precio: 52500,
    imagen: 'assets/products/Citrato zinc_fondo.jpg',
    destacado: false
  },
  {
    id: 5,
    nombre: 'Colágeno Hidrolizado + Biotina — Totalmax',
    categoria: 'Belleza',
    categoriasSecundarias: ['Bienestar'],
    descripcion: 'Suplemento alimenticio masticable con colágeno hidrolizado y biotina. Apoya el cuidado diario de la piel, el cabello y el bienestar general.\nBeneficios: piel radiante, cabello fuerte, elasticidad y brillo.\nCantidad: 30 unidades.\nConcentración: 600.\nContenido neto: 18 g.',
    precio: 48900,
    imagen: 'assets/products/Colageno_fondo.jpg',
    destacado: true
  },
  {
    id: 6,
    ...
    descripcion: 'Suplemento dietario en cápsulas con berberina, gymnema y trigo sarraceno. Apoya el equilibrio del azúcar, la función del páncreas y el control del peso.\nBeneficios: equilibrio del azúcar, páncreas y apoyo metabólico.\nCantidad: 100 cápsulas.\nConcentración: 300 mg.',
    precio: 68500,
    imagen: 'assets/products/Diab-Zan_fondo.jpg',
    destacado: false
  },
  {
    id: 7,
    ...
    descripcion: 'Suplemento dietario en cápsulas con plantas y extractos naturales. Apoya el hígado, la depuración, la digestión y el equilibrio general.\nBeneficios: apoyo hepático, eliminación de toxinas, digestión y bienestar.\nCantidad: 100 cápsulas.\nConcentración: 300 mg.',
    precio: 68500,
    imagen: 'assets/products/Hig-san_fondo.jpg',
    destacado: false
  },
  {
    id: 8,
    nombre: 'L-Arginina — Totalmax',
    categoria: 'Energía',
    categoriasSecundarias: ['Movimiento', 'Bienestar'],
    descripcion: 'Suplemento alimenticio masticable con L-Arginina. Apoya la energía diaria, el rendimiento y el bienestar general.\nBeneficios: energía, rendimiento y bienestar total.\nCantidad: 30 unidades.\nConcentración: 600.\nContenido neto: 18 g.',
    precio: 48350,
    imagen: 'assets/products/L-Arginina.jpg',
    destacado: false
  },
  {
    id: 9,
    ...
    descripcion: 'Suplemento dietario en cápsulas con vitaminas B6, C, D3 y maca. Apoya la energía, el ánimo activo y la vitalidad diaria.\nBeneficios: resistencia corporal, ánimo, energía y bienestar.\nCantidad: 100 cápsulas.\nConcentración: 300 mg.',
    precio: 68500,
    imagen: 'assets/products/Mac_fondo.jpg',
    destacado: false
  },
  {
    id: 10,
    nombre: 'Prebióticos + Probióticos — Totalmax',
    categoria: 'Digestión',
    categoriasSecundarias: ['Defensas', 'Bienestar'],
    descripcion: 'Suplemento alimenticio masticable con prebióticos y probióticos. Apoya el equilibrio intestinal, la digestión diaria y el bienestar digestivo.\nBeneficios: flora intestinal, digestión, absorción y bienestar.\nCantidad: 30 unidades.\nConcentración: 600.\nContenido neto: 18 g.',
    precio: 48500,
    imagen: 'assets/products/Prebioticos_fondo.jpg',
    destacado: true
  },
  {
    id: 11,
    nombre: 'Resveratrol + Colágeno Hidrolizado + Vitamina E — Totalmax',
    categoria: 'Belleza',
    categoriasSecundarias: ['Bienestar', 'Defensas'],
    descripcion: 'Suplemento alimenticio masticable con resveratrol, colágeno hidrolizado y vitamina E. Apoya el cuidado diario de la piel, la elasticidad, la firmeza y la acción antioxidante.\nBeneficios: piel radiante, elasticidad, firmeza y antioxidantes.\nCantidad: 30 unidades.\nConcentración: 600.\nContenido neto: 18 g.',
    precio: 47650,
    imagen: 'assets/products/Colageno + Resveratrol_fondo.jpg',
    destacado: false
  },
  {
    id: 12,
    nombre: 'UG-SANG DRA Prame',
    categoria: 'Energía',
    categoriasSecundarias: ['Bienestar', 'Digestión'],
    descripcion: 'Suplemento dietario en cápsulas formulado con vitamina B6, vitamina C, magnesio y extractos naturales. Apoya la circulación, la salud del corazón, la memoria y la concentración.\nBeneficios: circulación, corazón, apoyo digestivo y memoria.\nCantidad: 100 cápsulas.\nConcentración: 300 mg.',
    precio: 68500,
    imagen: 'assets/products/Ug-San Dra_fondo.jpg',
    destacado: false
  },
  {
    id: 13,
    ...
    categoria: 'Depuración',
    categoriasSecundarias: ['Defensas', 'Bienestar'],
    descripcion: 'Suplemento dietario en cápsulas orientado al cuidado de las vías urinarias. Contiene vitaminas, selenio y extractos naturales como uña de gato, arándano y cola de caballo.\nBeneficios: apoyo urinario, eliminación de líquidos y cuidado natural.\nCantidad: 100 cápsulas.\nConcentración: 300 mg.',
    precio: 68500,
    imagen: 'assets/products/Urol_fondo.jpg',
    destacado: false
  },
  {
    id: 14,
    nombre: 'Vitamina C 600 — Totalmax',
    categoria: 'Defensas',
    categoriasSecundarias: ['Energía', 'Bienestar'],
    descripcion: 'Suplemento alimenticio masticable con vitamina C. Apoya las defensas, la vitalidad diaria y la acción antioxidante.\nBeneficios: apoyo inmune, energía, antioxidantes y bienestar.\nCantidad: 30 unidades.\nConcentración: 600.',
    precio: 38500,
    imagen: 'assets/products/Vitamina c_fondo.jpg',
    destacado: true
  }
];
...
/* Sync UI prices with PRODUCTS data */
function initializePrices() {
  document.querySelectorAll('[data-price-id]').forEach(el => {
    const id = parseInt(el.dataset.priceId);
    const product = PRODUCTS.find(p => p.id === id);
    if (product) {
      el.textContent = formatPrice(product.precio);
    }
  });
}
...
function addToCart(productId) {
  ...
  /* Visual feedback: Bump the cart icon in header */
...
/* Global text normalizer for safer comparisons */
...
function filterCatalog() {
  ...
  const normalizedActiveCat = normalizeText(activeCategory);
  ...
  cards.forEach(card => {
    ...
    // Category matching
    const productCats = [product.categoria, ...(product.categoriasSecundarias || [])].map(c => normalizeText(c));
    const matchesCat = normalizedActiveCat === 'todos' || productCats.includes(normalizedActiveCat);
...
function setCategory(cat) {
  ...
  document.querySelectorAll('#categoriesGrid .category-card').forEach(btn => {
    const btnCat = normalizeText(btn.dataset.cat);
    btn.classList.toggle('active', btnCat === normCat);
  });
  /* Sidebar buttons */
  ...
  if (catalogEl && window.scrollY < catalogEl.offsetTop - 200) {
    setTimeout(() => catalogEl.scrollIntoView({ behavior: 'smooth', block: 'start' }), 50);
  }
}
...
function initSort() {
  ...
  const performSort = () => {
    ...
    const cards = Array.from(grid.querySelectorAll('.product-card-small'));
    ...
    cards.sort((a, b) => {
      ...
      switch (val) {
        case 'az':
          return prodA.nombre.localeCompare(prodB.nombre, 'es', { sensitivity: 'base' });
        case 'precio-asc':
          return (prodA.precio || 0) - (prodB.precio || 0);
        case 'precio-desc':
          return (prodB.precio || 0) - (prodA.precio || 0);
        case 'destacados':
          if (prodA.destacado !== prodB.destacado) {
            return prodA.destacado ? -1 : 1;
          }
          return prodA.id - prodB.id; // Secondary sort for stability
    ...
    // Ensure filters are still applied correctly in the new order
    filterCatalog();
  };

  select.addEventListener('change', performSort);
}
